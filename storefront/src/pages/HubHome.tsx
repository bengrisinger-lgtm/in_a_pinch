...
const TILES: Tile[] = [
  ...
  },
  {
    ...
    tag: 'Live',
    title: 'Customers',
    body: 'Search renters by name, phone, or email. Edit, merge duplicates, or remove.',
  },
  {
    href: '#staff-hire',
    tag: 'Live',
    title: 'New hire',
    body: 'Enter a new staff member, then invite them from the Vault. Onboarding required on first sign-in.',
  },
  {
    tag: 'Later',
